...
if (!class_exists('\\Codeception\\Codecept')) {
    if (stream_resolve_include_path('c:\inetpub\wwwroot\testrunner\composer\vendor\autoload.php')) {
        require_once 'c:\inetpub\wwwroot\testrunner\composer\vendor\autoload.php';
...
//$config_file=realpath(getenv("thisTestRun_testRunnerPath")).DIRECTORY_SEPARATOR."staging".DIRECTORY_SEPARATOR."codeception.yml";
$config_file='c:\inetpub\wwwroot\testrunner'.DIRECTORY_SEPARATOR."staging".DIRECTORY_SEPARATOR."codeception.yml";
