    ...
    public function __construct($params) {
        ...
        if ($params instanceof Protocol\Imap) {
            ...
            try {
                ...
                throw new \Zend\Mail\Exception\RuntimeException('cannot select INBOX, is this a valid transport?', 0, $e);
            }
            return;
        }

        if (!isset($params->user)) {
            throw new \Zend\Mail\Exception\InvalidArgumentException('need at least user in params');
        }
