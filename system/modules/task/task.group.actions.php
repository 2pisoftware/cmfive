...
function viewtaskgroup_GET(Web &$w) {
	...
	if (!empty($group_details)) {
		History::add(__("Taskgroup: ").$group_details->title);
	}
...
function deletetaskgroup_GET(Web &$w) {
	...
	// if is_active is set to '0', display 'Yes', else display 'No'
	$isactive = $group_details->is_active == "1" ? __("Yes") : __("No");

	// build static form displaying group details for confirmation of delete
	$f = Html::form(array(
	array(__("Task Group Details"),"section"),
	array(__("Task Group Type"),"static", "task_group_type",$group_details->getTypeTitle()),
	array(__("Title"),"static", "title",$group_details->title),
	array(__("Who Can Assign"),"static", "can_assign",$group_details->can_assign),
	array(__("Who Can View"),"static", "can_view",$group_details->can_view),
	array(__("Who Can Create"),"static", "can_create",$group_details->can_create),
	array(__("Is Active"),"static", "is_active", $isactive),
	array(__("Description"),"static", "description",$group_details->description),
	array(__("Default Assignee"),"static", "default_assignee_id",$w->Task->getUserById($group_details->default_assignee_id)),
	),$w->localUrl("/task-group/deletetaskgroup/".$group_details->id),"POST",__(" Delete "));
